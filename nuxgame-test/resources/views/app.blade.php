    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 80% 60% at 20% 0%, rgba(201,160,106,0.06) 0%, transparent 60%),
        ...
        .badge-win  { background: var(--win-glow);  color: var(--win); }
        .badge-lose { background: var(--lose-glow); color: var(--lose); }

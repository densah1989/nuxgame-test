...
<div class="page-wrap">
    <div class="page-inner">
        ...
        <div class="page-header fade-up">
            <div class="avatar">{{ strtoupper(substr($page->user->username, 0, 1)) }}</div>
            <h1 class="display page-greeting">Hello, {{ $page->user->username }}</h1>
            <p class="page-meta">{{ $page->user->phonenumber }}</p>
        </div>
        ...
        <div class="card card--glow fade-up fade-up-1">
            ...
            <div class="expiry">
                ...
                Active until {{ $page->expires_at->format('d M Y, H:i') }}
            </div>
            ...
            <div class="action-grid" style="margin-top:0.75rem">
                <form method="POST" action="{{ route('pages.regenerate', $page->route) }}">
                    @csrf
                ...
                <form method="POST" action="{{ route('pages.deactivate', $page->route) }}"
            ...
            {{-- Lucky button --}}
            <form method="POST" action="{{ route('rolls.lucky', $page->route) }}">
                @csrf
            ...
            <a class="history-link" href="{{ route('rolls.history', $page->route) }}">
                ◷ &nbsp;View last 3 results
            </a>
